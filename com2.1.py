...
llm_config=ChatGroq(groq_api_key=GROQ_API_KEY,
...
def management(query):
    ...
    for message in groupchat.messages:
        write_to_file(filename, f"{message['role']}: {message['content']}")
...
def code_generation(guide, topic):
    print("CALLED THE CODE GENERATION FUNCTION-------------------------------------------------------")
